## The node.js Coffee Shop app

[![CircleCI](https://img.shields.io/circleci/project/github/contentful/the-example-app.nodejs.svg)](https://circleci.com/gh/contentful/the-example-app.nodejs)

The node.js example app teaches the very basics of how to work with Express JS
...
```bash
git clone https://github.com/themawaras/coffee-shop-BE-NodeJS.git
cd coffee-shop-BE-NodeJS
```
